...
A great way to check your work is to call the `Get-WMIPE` function you created earlier.
...
For some more details on using WMI in Powershell 7, see my recently published [PowerShell 7 book](https://www.wiley.com/en-gb/PowerShell+7+for+IT+Professionals-p-9781119644705).
I devote a chapter 9 to WMI and using the CIM cmdlets.
You can find the scripts from this blog post and that chapter in my [GitHub repository](https://github.com/doctordns/Wiley20/tree/master/09%20-%20WMI).